...
legacyUrl: "https://www.cuidatuperroviejo.com/p/salud-mental-y-emocional-en-perros.html"
---
...
<div class="border border-gray-200 dark:border-gray-800 p-5 my-6 rounded-xl bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
  <h3 class="text-lg font-bold mb-2">Descarga el checklist para cuidar la mente y las emociones de tu perro senior</h3>
  <p class="mb-3">Documento imprimible con acciones diarias para reducir estrés, mejorar su entorno y estimular su cerebro.</p>
  <p><a href="https://drive.google.com/file/d/1WpG3vVpkaVgxTqYiSvfyFrwoRgrtUEY8/view?usp=sharing" target="_blank" class="inline-block bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 text-white font-medium px-4 py-2 rounded-lg transition-colors">📄 Descargar checklist</a></p>
</div>
