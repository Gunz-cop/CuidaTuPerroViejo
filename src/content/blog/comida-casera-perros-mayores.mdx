    ...
    <div class="mt-4 text-brand-muted leading-relaxed">
      ...
      <ul class="space-y-4 text-sm pl-0 list-none">
        <li class="relative pl-6">
          ...
          <span class="font-semibold bg-brand-bg px-2 py-0.5 rounded border border-brand-border/40 text-xs mr-2">WSAVA</span>
          <a href="https://wsava.org/global-guidelines/global-nutrition-guidelines/" target="_blank" rel="noopener noreferrer" class="text-brand-primary hover:underline">Global Nutrition Guidelines</a> — Criterios para evaluación nutricional individualizada.
        </li>
        <li class="relative pl-6">
          <span class="absolute left-0">🔬</span>
          <span class="font-semibold bg-brand-bg px-2 py-0.5 rounded border border-brand-border/40 text-xs mr-2">AAHA</span>
          <a href="https://www.aaha.org/wp-content/uploads/globalassets/02-guidelines/2023-aaha-senior-care-guidelines-for-dogs-and-cats/resources/2023-aaha-senior-care-guidelines-for-dogs-and-cats.pdf" target="_blank" rel="noopener noreferrer" class="text-brand-primary hover:underline">Senior Care Guidelines for Dogs (2023)</a> — Manejo de hiporexia y soporte nutricional.
        </li>
        <li class="relative pl-6">
          <span class="absolute left-0">🔬</span>
          <span class="font-semibold bg-brand-bg px-2 py-0.5 rounded border border-brand-border/40 text-xs mr-2">PubMed</span>
          <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC8914307/" target="_blank" rel="noopener noreferrer" class="text-brand-primary hover:underline">Protein Requirements & Sarcopenia in Senior Dogs</a> — Evidencia sobre requerimientos proteicos.
        </li>
        <li class="relative pl-6">
          <span class="absolute left-0">🔬</span>
          <span class="font-semibold bg-brand-bg px-2 py-0.5 rounded border border-brand-border/40 text-xs mr-2">UC Davis</span>
          <a href="https://www.vetmed.ucdavis.edu/hospital/small-animal/nutrition" target="_blank" rel="noopener noreferrer" class="text-brand-primary hover:underline">Veterinary Nutrition Resources</a> — Hidratación y manejo dietético geriátrico.
        </li>
        <li class="relative pl-6">
          <span class="absolute left-0">🔬</span>
          <span class="font-semibold bg-brand-bg px-2 py-0.5 rounded border border-brand-border/40 text-xs mr-2">Frontiers Vet Sci</span>
          <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC12181554/" target="_blank" rel="noopener noreferrer" class="text-brand-primary hover:underline">Omega-3 & Cognitive Function in Aging Dogs</a> — Neuroprotección dietética.
        </li>
        <li class="relative pl-6">
          <span class="absolute left-0">🔬</span>
          <span class="font-semibold bg-brand-bg px-2 py-0.5 rounded border border-brand-border/40 text-xs mr-2">FDA</span>
          <a href="https://www.fda.gov/animal-veterinary/animal-health-literacy/get-facts-raw-pet-food-diets-can-be-dangerous-you-and-your-pet" target="_blank" rel="noopener noreferrer" class="text-brand-primary hover:underline">Safety of Raw & Homemade Pet Foods</a> — Riesgos bacteriológicos.
        </li>
        <li class="relative pl-6">
          <span class="absolute left-0">🔬</span>
          <span class="font-semibold bg-brand-bg px-2 py-0.5 rounded border border-brand-border/40 text-xs mr-2">ACVN</span>
          <a href="https://www.acvn.org/" target="_blank" rel="noopener noreferrer" class="text-brand-primary hover:underline">American College of Veterinary Nutrition</a> — Directorio de nutricionistas certificados.
        </li>
      </ul>
...
<section class="mt-16 pt-12 border-t border-brand-border">
  <h3 class="text-2xl font-extrabold text-brand-text mb-8 tracking-tight">Sigue aprendiendo sobre cuidados senior</h3>
  
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
    <a 
      href="/p/alimentacion-perro-senior.html" 
    ...
    >
      ...
      <div>
        <div class="aspect-video w-full overflow-hidden bg-gray-100 dark:bg-gray-800 rounded-lg mb-4">
          <img 
            alt="Guía de alimentación para perros senior" 
        ...
        <h4 class="text-lg font-bold text-brand-text group-hover:text-brand-accent transition-colors leading-snug line-clamp-2">
          Alimentación del perro senior: porciones y menús
        </h4>
        <p class="text-brand-muted text-sm mt-2 leading-relaxed line-clamp-2">
          Criterios para una nutrición adaptada y planes de alimentación senior.
        </p>
      </div>
    ...
    >
      ...
      <div>
        <div class="aspect-video w-full overflow-hidden bg-gray-100 dark:bg-gray-800 rounded-lg mb-4">
          <img 
            alt="Veterinario revisando a un perro mayor en consulta" 
            src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhFmsHktRFlX9whHUr78Kv7gMaEf3DN4F5lduPA0raTiqWxHBeWnIdnp_1GWCNOaImVl994NJ_vWqCmjVl6bowMbPprKvJzdB0elecsoO9ZqFbeDzjP7kYkhUl6Jn3Cmu2mmJOfMOVNf0hqiNXgmMK0XbgW6oIo5ONSRtfDXwqBCxNe4o3hibFx7gKSwZ4/s1600/perro-mayor-consulta-veterinaria.webp" 
            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
            loading="lazy"
          />
        </div>
        <h4 class="text-lg font-bold text-brand-text group-hover:text-brand-accent transition-colors leading-snug line-clamp-2">
          Chequeo geriátrico canino: calendario y pruebas clave
        </h4>
        <p class="text-brand-muted text-sm mt-2 leading-relaxed line-clamp-2">
    ...
    <a 
      href="/2025/10/vacunas-desparasitacion-perros-senior.html" 
      class="group flex flex-col justify-between p-5 bg-brand-card dark:bg-brand-bg/50 border border-brand-border rounded-xl hover:shadow-sm hover:border-brand-primary/40 transition-all duration-300 relative overflow-hidden"
    >
      <div class="absolute top-0 left-0 right-0 h-1 bg-brand-primary transform -translate-y-1 group-hover:translate-y-0 transition-transform duration-300"></div>
      <div>
        <div class="aspect-video w-full overflow-hidden bg-gray-100 dark:bg-gray-800 rounded-lg mb-4">
          <img 
            alt="Perro senior recibiendo vacuna en veterinaria" 
            src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhIYaQfmZlNhelAu5iuhm4kJSLXDLJWnMQ-4VASmi6ieo2tLQJKAcjfMH4-d_abL4vhTpmK3uhFsgJNHmsxeu5rCKuhRSNtrnPeYlWm4CrNgc_vN17xQvQvFrDARQ7fnHRs6c8DEth6xeZYpE1Y-KqGWHIB1iurtuZz2xzII_IWIdDAMFJfv29XBl8n7sg/s1600-rw/vacunacion-perro-senior-veterinario.webp" 
            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
            loading="lazy"
          />
        </div>
        <h4 class="text-lg font-bold text-brand-text group-hover:text-brand-accent transition-colors leading-snug line-clamp-2">
          Vacunas y desparasitación en perros senior
        </h4>
        <p class="text-brand-muted text-sm mt-2 leading-relaxed line-clamp-2">
          Pautas y consejos sobre vacunación en edades avanzadas.
        </p>
      </div>
      <div class="mt-4 flex items-center text-xs font-semibold text-brand-primary group-hover:text-brand-accent transition-colors duration-200">
        <span>Leer guía</span>
    ...
    <a 
      href="/2025/10/salud-dental-perros-mayores.html" 
      class="group flex flex-col justify-between p-5 bg-brand-card dark:bg-brand-bg/50 border border-brand-border rounded-xl hover:shadow-sm hover:border-brand-primary/40 transition-all duration-300 relative overflow-hidden"
    >
      <div class="absolute top-0 left-0 right-0 h-1 bg-brand-primary transform -translate-y-1 group-hover:translate-y-0 transition-transform duration-300"></div>
      <div>
        <div class="aspect-video w-full overflow-hidden bg-gray-100 dark:bg-gray-800 rounded-lg mb-4">
          <img 
            alt="Revisión dental de perro mayor en clínica veterinaria" 
            src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhWhW2jQtoIJAIrR7zW2N_ioKb89qxRnOJwVfMRVxcTmxveUVoFwpaYcCJXE8RaglUFSWZaOMgQ7t6-T7gq4lJZkMSxEQDqZbLdJm5gGN5UAuH6LBNXtOd_xtT2s8VJo-E7FfcOpRRXMSwz4dTpJGqYCS1v4N5bGdlsMx_GAVLB12bpJr3HEfn9W00ELog/s1600-rw/Veterinario_cepillando_dientes_de_perro_exotico_mayor.webp" 
            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
            loading="lazy"
          />
        </div>
        <h4 class="text-lg font-bold text-brand-text group-hover:text-brand-accent transition-colors leading-snug line-clamp-2">
          Salud dental en perros mayores: prevención y limpieza
        </h4>
        <p class="text-brand-muted text-sm mt-2 leading-relaxed line-clamp-2">
          Cómo cuidar sus encías y evitar la dolorosa enfermedad periodontal.
        </p>
      </div>
      <div class="mt-4 flex items-center text-xs font-semibold text-brand-primary group-hover:text-brand-accent transition-colors duration-200">
        <span>Leer guía</span>
